class Game {
  constructor(p1, p2, p3, p4, height = 6, width = 7) {
  ...
  handleClick(evt) {
    ...
    if(this.currPlayer === this.players[0]){
      ...
      this.currPlayer = this.players[3];
    }else if(this.currPlayer === this.players[3]){
...
document.getElementById('start-game').addEventListener('click', () => {
  ...
  let p3 = new Player(document.getElementById('p3-color').value);
  let p4 = new Player(document.getElementById('p4-color').value);
